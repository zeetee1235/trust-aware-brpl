#!/usr/bin/env python3
"""Generate better-parent path-margin sweep variants on top of J580/W630 + PRR_BASE."""
...
VARIANTS = [
    {
        "proto": "TABRPL_PTH_064",
        "comment": "Aggressive path-margin relaxation.",
        "trust_margin": 50,
        "path_margin": 64,
    },
    {
        "proto": "TABRPL_PTH_128",
        "comment": "Moderately relaxed path margin.",
        "trust_margin": 50,
        "path_margin": 128,
    },
    {
        "proto": "TABRPL_PTH_256",
        "comment": "Baseline path margin.",
        "trust_margin": 50,
        "path_margin": 256,
    },
    {
        "proto": "TABRPL_PTH_384",
        "comment": "Conservative path margin.",
        "trust_margin": 50,
        "path_margin": 384,
    },
]

MAKEFILE_TEMPLATE = """# Auto-generated path-margin sweep variant
# {comment}
