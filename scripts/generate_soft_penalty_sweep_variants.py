#!/usr/bin/env python3
"""Generate soft-penalty sweep variants on top of J580/W630 + baseline PRR/margin."""
...
VARIANTS = [
    {
        "proto": "TABRPL_SFT_BASE",
        "comment": "Baseline soft penalty.",
        "trust_lambda_penalty": 450,
        "trust_penalty_gamma": 1,
        "current_parent_penalty": 700,
    },
    {
        "proto": "TABRPL_SFT_G2",
        "comment": "Quadratic trust penalty for stronger separation near low trust.",
        "trust_lambda_penalty": 450,
        "trust_penalty_gamma": 2,
        "current_parent_penalty": 700,
    },
    {
        "proto": "TABRPL_SFT_L600",
        "comment": "Higher trust penalty weight.",
        "trust_lambda_penalty": 600,
        "trust_penalty_gamma": 1,
        "current_parent_penalty": 700,
    },
    {
        "proto": "TABRPL_SFT_G2L600",
        "comment": "Higher weight plus quadratic slope.",
        "trust_lambda_penalty": 600,
        "trust_penalty_gamma": 2,
        "current_parent_penalty": 700,
    },
...
MAKEFILE_TEMPLATE = """# Auto-generated soft-penalty sweep variant
# {comment}
...
CFLAGS += -DBRPL_CONF_TRUST_LAMBDA_PENALTY={trust_lambda_penalty}
CFLAGS += -DTRUST_PENALTY_GAMMA_CONF={trust_penalty_gamma}
CFLAGS += -DBRPL_CONF_CURRENT_PARENT_PENALTY_SCALE={current_parent_penalty}
LDLIBS += -lm
