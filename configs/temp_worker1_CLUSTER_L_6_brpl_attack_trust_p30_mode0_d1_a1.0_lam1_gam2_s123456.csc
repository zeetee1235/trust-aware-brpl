...
<simconf>
  <simulation>
    ...
    <motetype>
      ...
      <commands>/usr/bin/make -C ../motes -f Makefile.receiver -j receiver_root.cooja BUILD_DIR_BOARD=build_worker1 TARGET=cooja WERROR=0 DEFINES=BRPL_MODE=1,TRUST_LAMBDA=1,TRUST_GAMMA=2,TRUST_PENALTY_GAMMA=2,TRUST_LAMBDA_CONF=1,TRUST_PENALTY_GAMMA_CONF=2,ATTACK_MODE=0,ATTACKER_NODE_ID=2</commands>
    ...
    <motetype>
      ...
      <commands>/usr/bin/make -C ../motes -f Makefile.sender -j sender.cooja BUILD_DIR_BOARD=build_worker1 TARGET=cooja WERROR=0 DEFINES=BRPL_MODE=1,TRUST_ENABLED=1,TRUST_LAMBDA=1,TRUST_GAMMA=2,TRUST_PENALTY_GAMMA=2,TRUST_LAMBDA_CONF=1,TRUST_PENALTY_GAMMA_CONF=2,SEND_INTERVAL_SECONDS=10,WARMUP_SECONDS=10,ATTACK_MODE=0,ATTACKER_NODE_ID=2</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiVib</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiMoteID</moteinterface>
    ...
    <motetype>
      ...
      <commands>/usr/bin/make -C ../motes -f Makefile.attacker -j attacker.cooja BUILD_DIR_BOARD=build_worker1 TARGET=cooja WERROR=0 DEFINES=BRPL_MODE=1,TRUST_LAMBDA=1,TRUST_GAMMA=2,TRUST_PENALTY_GAMMA=2,TRUST_LAMBDA_CONF=1,TRUST_PENALTY_GAMMA_CONF=2,ATTACK_DROP_PCT=30,ATTACK_MODE=0,WARMUP_SECONDS=10,ATTACKER_NODE_ID=2</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiVib</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiMoteID</moteinterface>
...
var trustFile = "/home/research/TA-BRPL/results/experiments-20260305-103622/CLUSTER_L_6_brpl_attack_trust_p30_mode0_d1_a1.0_lam1_gam2_s123456/trust_feedback.txt";
var lastCheckMs = 0;
var lastPos = 0;
function pollTrust() {
  try {
