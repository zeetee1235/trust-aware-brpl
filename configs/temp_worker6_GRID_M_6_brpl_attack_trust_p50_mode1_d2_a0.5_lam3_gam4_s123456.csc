...
<simconf>
  <simulation>
    ...
    <motetype>
      ...
      <commands>/usr/bin/make -C ../motes -f Makefile.receiver -j receiver_root.cooja BUILD_DIR_BOARD=build_worker6 TARGET=cooja WERROR=0 DEFINES=BRPL_MODE=1,TRUST_LAMBDA=3,TRUST_GAMMA=4,TRUST_PENALTY_GAMMA=4,TRUST_LAMBDA_CONF=3,TRUST_PENALTY_GAMMA_CONF=4,ATTACK_MODE=1,ATTACKER_NODE_ID=2</commands>
    ...
    <motetype>
      ...
      <commands>/usr/bin/make -C ../motes -f Makefile.sender -j sender.cooja BUILD_DIR_BOARD=build_worker6 TARGET=cooja WERROR=0 DEFINES=BRPL_MODE=1,TRUST_ENABLED=1,TRUST_LAMBDA=3,TRUST_GAMMA=4,TRUST_PENALTY_GAMMA=4,TRUST_LAMBDA_CONF=3,TRUST_PENALTY_GAMMA_CONF=4,SEND_INTERVAL_SECONDS=10,WARMUP_SECONDS=10,ATTACK_MODE=1,ATTACKER_NODE_ID=2</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiVib</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiMoteID</moteinterface>
    ...
    <motetype>
      ...
      <commands>/usr/bin/make -C ../motes -f Makefile.attacker -j attacker.cooja BUILD_DIR_BOARD=build_worker6 TARGET=cooja WERROR=0 DEFINES=BRPL_MODE=1,TRUST_LAMBDA=3,TRUST_GAMMA=4,TRUST_PENALTY_GAMMA=4,TRUST_LAMBDA_CONF=3,TRUST_PENALTY_GAMMA_CONF=4,ATTACK_DROP_PCT=50,ATTACK_MODE=1,WARMUP_SECONDS=10,ATTACKER_NODE_ID=2</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiVib</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiMoteID</moteinterface>
...
var trustFile = "/home/research/TA-BRPL/results/experiments-20260305-103622/GRID_M_6_brpl_attack_trust_p50_mode1_d2_a0.5_lam3_gam4_s123456/trust_feedback.txt";
var lastCheckMs = 0;
var lastPos = 0;
function pollTrust() {
  try {
