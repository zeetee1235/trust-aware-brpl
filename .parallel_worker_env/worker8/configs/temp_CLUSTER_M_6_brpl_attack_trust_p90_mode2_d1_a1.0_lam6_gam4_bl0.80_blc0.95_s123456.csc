...
<simconf>
  <simulation>
    ...
    <motetype>
      ...
      <commands>/usr/bin/make -C ../motes CONTIKI=/home/research/TA-BRPL/contiki-ng-brpl -f Makefile.sender -j sender.cooja TARGET=cooja WERROR=0 DEFINES=BRPL_MODE=1,TRUST_ENABLED=1,TRUST_LAMBDA=6,TRUST_GAMMA=4,TRUST_PENALTY_GAMMA=4,TRUST_LAMBDA_CONF=6,TRUST_PENALTY_GAMMA_CONF=4,SEND_INTERVAL_SECONDS=10,WARMUP_SECONDS=10,ATTACK_MODE=2,ATTACKER_NODE_ID=2,BLACKLIST_TRUST_THRESHOLD_NORM=0.80,BLACKLIST_TRUST_CLEAR_THRESHOLD_NORM=0.95,RPL_BASELINE_MODE=0</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiVib</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiMoteID</moteinterface>
...
var trustFile = "/home/research/TA-BRPL/results/experiments-20260305-173221/CLUSTER_M_6_brpl_attack_trust_p90_mode2_d1_a1.0_lam6_gam4_bl0.80_blc0.95_s123456/trust_feedback.txt";
var lastCheckMs = 0;
var lastPos = 0;
function pollTrust() {
  try {
