...
<simconf>
  <simulation>
    <title>CHOKEPOINT 2-CLUSTER M (N=40)</title>
    ...
    <motetype>
      ...
      <source>[CONFIG_DIR]/../motes/attacker.c</source>
      <commands>/usr/bin/make -C ../motes CONTIKI=/home/research/TA-BRPL/contiki-ng-brpl -f Makefile.attacker -j attacker.cooja TARGET=cooja WERROR=0 DEFINES=BRPL_MODE=1,TRUST_LAMBDA=6,TRUST_GAMMA=4,TRUST_PENALTY_GAMMA=4,TRUST_LAMBDA_CONF=6,TRUST_PENALTY_GAMMA_CONF=4,ATTACK_DROP_PCT=5,ATTACK_MODE=2,WARMUP_SECONDS=120,ATTACK_WARMUP_SECONDS=120,ATTACKER_NODE_ID=2,TRUST_ENABLED=1,BLACKLIST_TRUST_THRESHOLD_NORM=0.90,BLACKLIST_TRUST_CLEAR_THRESHOLD_NORM=0.95,RPL_BASELINE_MODE=0</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiVib</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiMoteID</moteinterface>
...
var trustFile = "/home/research/TA-BRPL/results/experiments-20260305-195155/CLUSTER_M_6_brpl_attack_trust_p5_mode2_d1_a1.0_lam6_gam4_bl0.90_blc0.95_s456789/trust_feedback.txt";
var lastCheckMs = 0;
var lastPos = 0;
function pollTrust() {
  try {
